...
function fillTree() {
  ...
  if (toolpathsInScene.length > 0) {
    ...
    var instructions = `<p class="text-secondary">Please select some entities by clicking them in the viewer.  Hold down Ctrl to select more than one in the viewer, or from the Documents tree above. Add them to a toolpath using the <kbd class="bg-cnc-enhancement"> <i class="fa fa-plus" aria-hidden="true"></i> Add</kbd> button</p>`
